...
y_labeled_adapted[y_labeled == 4] = 1
...
y_unlabeled_numpy[y_unlabeled_numpy == 1] = 4
df = pd.DataFrame(y_unlabeled_numpy)
df.to_csv('./ex04_results/y_unlabeled.csv', index=False, header=False)
...
y_val_numpy[y_val_numpy == 1] = 4
df = pd.DataFrame(y_val_numpy)
df.to_csv('./ex04_results/y_val.csv', index=False, header=False)

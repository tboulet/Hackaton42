...
# Modify the path to your data
DATASET = './datasets/02_mnist_constant_image'

X_labeled = np.load(join(DATASET, "X_labeled.npy"))
y_labeled = np.load(join(DATASET, "y_labeled.npy"))
X_unlabeled = np.load(join(DATASET, "X_unlabeled.npy"))
X_val = np.load(join(DATASET, "X_val.npy"))
